...
public class SignInCompanyActivity extends AppCompatActivity
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.gobackbtn:
                startActivity(new Intent(SignInCompanyActivity.this,SignInOption.class));
                break;
    ...
    private void updateStatus() {
        ...
        if (user != null) {
            Toast.makeText(SignInCompanyActivity.this,
    ...
    private void userProfile(){
        ...
        DatabaseReference currentUserDB = FirebaseDatabase.getInstance().getReference().child("Users").child("Company").child(userId);
        Map newPost = new HashMap();
        newPost.put("company_name", name);
        newPost.put("age", age);
        ...
        usersDBTypes.put("type", "company");
        usersDB.setValue(usersDBTypes);

        startActivity(new Intent(SignInCompanyActivity.this, BossMapActivity.class));
